...
- Start by validating the new full-height Practice/Debug workspace in Chromium with Synthesia collapsed and expanded: confirm layering above the right side of the piano/timeline, scrolling, resizing, tab keyboard navigation, collapse/restore, and auto-hide-on-play.

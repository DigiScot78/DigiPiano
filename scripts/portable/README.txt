...
3. Keep the console window open while using DigiPiano.
...
Stop the app
------------
Close the DigiPiano console window or press Ctrl+C in it. The browser tab can then be closed.
...
- If the app reports that port 4173 is busy, close another DigiPiano console or the program using that port, then try again.
